...
- `{material}.json`: The material file that contains the material model parameters which are to be optimized. Each parameter should be defined by given a range of values, such as `youngs_modulus: [0.1, 0.5]`.
